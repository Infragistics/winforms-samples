...
namespace Elemental
{
    ...
    public partial class frmMain : Form
    {
        ...
        private HoodieStyle currentStyle = frmMain.InitialStyle;
        ...
        private void InitializeUI()
        {
            ...
            this.InitializeCarousel(frmMain.InitialStyle);
            this.InitializePivotGrid();
            this.OnItemSelected(frmMain.InitialStyle);
            this.SetLabelImages();
        ...
        private void InitializeDateFilterDropDown()
        {
            ...
            this.cmdDateFilter.TextRenderingMode = frmMain.TextRenderingMode;
            ...
            this.cmdDateFilter.ImageSize = frmMain.DropDownButtonSize;
            ...
            this.cmdDateFilter.Font = new Font(frmMain.FontFamily, 12f);
            ...
            delegate(object sender, EventArgs e)
            {
                ...
                else
                {
                    ...
                    Control dropDownControl = this.CreateDateFilterDropDownControl(frmMain.DropDownSize, frmMain.DropDownCommandButtonSize, frmMain.DropDownPadding);
        ...
        private Control CreateDateFilterDropDownControl(Size size, Size buttonSize, int padding)
        {
            if ( this.dateFilterDropDownControl == null )
            {
                ...
                cmdOk.TextRenderingMode = frmMain.TextRenderingMode;
                ...
                cmdCancel.TextRenderingMode = frmMain.TextRenderingMode;
        ...
        private UltraTree CreateDateFilterTree()
        {
            if ( this.dateFilterTree == null )
            {
                ...
                //  Use GDI text rendering for anti-aliasing
                this.dateFilterTree.TextRenderingMode = frmMain.TextRenderingMode;
        ...
        private void InitializeLabelControls()
        {
            ...
            foreach ( UltraLabel label in labels )
            {
                ...
                label.Appearance.FontData.Name = frmMain.FontFamily;
                ...
                //  Use GDI text rendering for anti-aliasing.
                label.TextRenderingMode = frmMain.TextRenderingMode;
            }
            ...
            this.lblSelected.Appearance.FontData.Name = frmMain.FontFamily;
            this.lblSelected.Appearance.FontData.SizeInPoints = 11f;
            this.lblSelected.Appearance.ForeColor = labelForeColor;
            this.lblSelected.TextRenderingMode = frmMain.TextRenderingMode;
        ...
        private void SetLabelImages()
        {
            ...
            foreach ( UltraLabel label in labels )
            {
                ...
                label.Tag = style;
                Image image = Assets.ImageServer.GenerateColorImage(this.Colors[style], frmMain.LabelImageSize);
                ...
                label.ImageSize = frmMain.LabelImageSize;
            }
        }
        ...
        private void InitializePivotGrid()
        {
            ...
            this.grid.TextRenderingMode = frmMain.TextRenderingMode;
            ...
            {
                this.grid.SetRowHeaderColumnWidth(0, frmMain.RowHeaderWidth);
            };
        ...
        {
            int itemSlots = frmMain.CarouselItemSlots;
            int animationFrames = frmMain.CarouselAnimationFrames;

            //  Show scroll buttons
            this.carousel.ScrollButtonSize = frmMain.ScrollButtonSize;
        ...
        private void SetTitle()
        {
            ...
            string fontFamily = frmMain.FontFamily;
        ...
        private void OnItemSelected(HoodieStyle style)
        {
            ...
            Image image = Assets.ImageServer.GenerateColorImage(color, frmMain.SelectedLabelImageSize);
            this.lblSelected.Appearance.Image = image;
            this.lblSelected.ImageSize = frmMain.SelectedLabelImageSize;
